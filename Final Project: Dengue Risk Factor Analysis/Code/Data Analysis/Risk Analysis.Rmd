...
-   Interpretation: The coefficient associated with having door screens is 0.15, meaning that the log odds of having a dengue infection increase by 0.15 if you do not have a screen door. The odds ratio of having an infection without a screen door is 1.16; however, since the p-value = 0.0975, and this is greater than 0.05, this means that the odds ratio is not statistically significant.
...
*Interpretation:* The odds ratio of being infected with dengue is 1.12 if you do not have door screens, compared to having door screens; however the p-value is greater than 0.05 so it is not statistically significant.
