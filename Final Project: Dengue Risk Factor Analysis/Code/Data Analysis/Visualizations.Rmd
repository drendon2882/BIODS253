...
```{r}
ggplot(merged_dengue_data, aes(x = house_type, y = n_any_infections, color = house_type)) + 
  geom_boxplot() + 
...
# Save the plot
ggsave(filename = "Final Project: Dengue Risk Factor Analysis/Figures/my_plot.png", plot = , width = 6, height = 4, dpi = 300)
